    ...
    >
      ...
      <div className="absolute top-2 right-2 z-10 flex flex-col gap-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
        <Toggle
          ...
          onPressedChange={() => onToggleWishlist()}
          onClick={(e) => e.stopPropagation()}
          className="flex h-7 w-7 items-center justify-center rounded-full transition-colors bg-gray-800/80 text-gray-400 hover:text-rose-400 data-[pressed]:bg-rose-500 data-[pressed]:text-white"
        ...
        <Toggle
          ...
          onClick={(e) => e.stopPropagation()}
          className="flex h-7 w-7 items-center justify-center rounded-full transition-colors bg-gray-800/80 text-gray-400 hover:text-emerald-400 data-[pressed]:bg-emerald-500 data-[pressed]:text-white"
